            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4"><div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center"><LocationMarkerIcon /></div><div><h3 className="text-lg font-semibold text-gray-800">Endereço</h3><p className="text-gray-600">Rua das Flores, 123<br />Centro, São Paulo - SP, 01234-567</p></div></div>
                  <div className="flex items-start gap-4"><div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center"><PhoneIcon /></div><div><h3 className="text-lg font-semibold text-gray-800">Telefone</h3><p className="text-gray-600">(11) 9999-9999<br />(11) 8888-8888</p></div></div>
                  <div className="flex items-start gap-4"><div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center"><MailIcon /></div><div><h3 className="text-lg font-semibold text-gray-800">Email</h3><p className="text-gray-600">contato@loja.com.br<br />suporte@loja.com.br</p></div></div>
              ...
              <div id="mapa" className="bg-gray-200 h-64 rounded-2xl shadow-lg overflow-hidden"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.197532375129!2d-46.6364953844739!3d-23.56135156760215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0x2da5e6c3c5a0b1f0!2sRua%20das%20Flores%2C%20123%20-%20Centro%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2001234-567!5e0!3m2!1spt-BR!2sbr!4v1678886400000!5m2!1spt-BR!2sbr" width="100%" height="100%" style={{ border: 0 }} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Mapa de Localização"></iframe></div>
            </div>
          </div>
        </div>
      </main>
